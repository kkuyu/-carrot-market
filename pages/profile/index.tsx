      ...
      <div className="container pt-5 pb-5">
        <div>
          <button className="flex items-center w-full space-x-3 text-left">
            ...
            <div>
              <strong className="font-semibold text-gray-900">Steve Jebs</strong>
              <p className="text-sm text-gray-700">Edit profile &rarr;</p>
            </div>
          </button>
        </div>
        <div className="mt-10">
          <div className="flex justify-around">
            <button type="button" className="flex flex-col items-center">
              ...
              <span className="mt-2 text-sm font-semibold text-gray-700">판매내역</span>
            </button>
            <button type="button" className="flex flex-col items-center">
              <div className="flex items-center justify-center w-14 h-14 text-white bg-orange-500 rounded-full">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="mt-2 text-sm font-semibold text-gray-700">구매내역</span>
            </button>
            <button type="button" className="flex flex-col items-center">
              <div className="flex items-center justify-center w-14 h-14 text-white bg-orange-500 rounded-full">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="mt-2 text-sm font-semibold text-gray-700">관심목록</span>
            </button>
          </div>
        </div>
        <div className="mt-12">
