...
const Images = (props: ImagesProps) => {
  const { alt = "", size = "3.5rem", ratioX = 1, ratioY = 1, cloudId, className = "", ...restProps } = props;
  ...
  return (
    <div className={`relative bg-slate-300 overflow-hidden ${className}`} style={{ width: size, height: size }} {...restProps}>
      ...
      {cloudId ? (
        ...
        />
      ) : imageState.isMounted || imageState.isError ? (
